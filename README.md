...
- 배포 주소 : http://52.78.197.58:8080/ObAsset 

  > 아이디, 비밀번호 찾기, 회원가입에서 사용자가 이메일로 인증코드를 수신하고 입력해야하는 기능이 있으나,<br>
  AWS에서 SMTP프로토콜의 보안상의 문제로 이메일 인증 기능을 사용할 수 없어 회원가입 기능을 불가합니다. <br>
